package org.o7.planning.sbmultids.config;
...
public class DataSource1Config {
    ...
    public LocalContainerEntityManagerFactoryBean ds1EntityManager() {
        ...
        em.setPackagesToScan(new String[] { org.o7planning.sbmultids.config.Constants.PACKAGE_ENTITIES_1 });
        em.setPersistenceUnitName(org.o7planning.sbmultids.config.Constants.JPA_UNIT_NAME_1); // Important !!
