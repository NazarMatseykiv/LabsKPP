...
public class DataSource2Config {
    ...
    public LocalContainerEntityManagerFactoryBean ds2EntityManager() {
        ...
        em.setPackagesToScan(new String[] { org.o7planning.sbmultids.config.Constants.PACKAGE_ENTITIES_2 });

        em.setPersistenceUnitName(org.o7planning.sbmultids.config.Constants.JPA_UNIT_NAME_2);
